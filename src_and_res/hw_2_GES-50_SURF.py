...
surf = cv.xfeatures2d_SURF.create(2750)
...
surf = cv.xfeatures2d_SURF.create(3250)  # 3250
...
surf = cv.xfeatures2d_SURF.create(2500)  # 2500
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+4990, img_1_2.shape[0]))
...
cv.imwrite('GES-50/Stitched_Surf.jpg', img_all)
