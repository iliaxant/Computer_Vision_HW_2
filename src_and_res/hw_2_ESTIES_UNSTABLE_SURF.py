...
surf = cv.xfeatures2d_SURF.create(1500)
...
surf = cv.xfeatures2d_SURF.create(500)  # 3250
...
img_1_2 = cv.warpPerspective(img2, M, (img1.shape[1]+365, img1.shape[0]+320))
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+375, img3.shape[0]+265))
...
surf = cv.xfeatures2d_SURF.create(4000)  # 700
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+2410, img_1_2.shape[0]+800))
...
cv.imwrite('ESTIES_UNSTABLE/Stitched_Surf.jpg', img_all)
