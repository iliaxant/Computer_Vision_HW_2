...
sift = cv.xfeatures2d_SIFT.create(2600)

# # Image 1 # #

img1 = cv.imread('GES-50/0.jpg')  # All images in GES-50 have resolution: (2252, 4000)

cv.namedWindow('Building_1', cv.WINDOW_NORMAL)
cv.imshow('Building_1', img1)
cv.waitKey(0)
...
cv.imshow('Building_1', k_img1)
cv.waitKey(0)

# # Image 2 # #

img2 = cv.imread('GES-50/1.jpg')

cv.namedWindow('Building_2', cv.WINDOW_NORMAL)
cv.imshow('Building_2', img2)
cv.waitKey(0)
...
img3 = cv.imread('GES-50/2.jpg')

cv.namedWindow('Building_3', cv.WINDOW_NORMAL)
cv.imshow('Building_3', img3)
cv.waitKey(0)
...
cv.imshow('Building_3', k_img3)
cv.waitKey(0)

# # Image 4 # #

img4 = cv.imread('GES-50/3.jpg')

cv.namedWindow('Building_4', cv.WINDOW_NORMAL)
cv.imshow('Building_4', img4)
cv.waitKey(0)
...
img_1_2 = cv.warpPerspective(img2, M, (img1.shape[1]+1100, img1.shape[0]))
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+1100, img3.shape[0]))
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+5000, img_1_2.shape[0]))  # 800
...
cv.imwrite('GES-50/Stitched_Sift.jpg', img_all)
