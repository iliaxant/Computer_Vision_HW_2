...
sift = cv.xfeatures2d_SIFT.create(100)  # or 600

# # Image 1 # #

img1 = cv.imread('OpenPano/flower/1.jpg')  # All images in OpenPano have resolution: (795, 1200)

cv.namedWindow('Flower_1', cv.WINDOW_NORMAL)
cv.imshow('Flower_1', img1)
cv.waitKey(0)
...
cv.imshow('Flower_1', k_img1)
cv.waitKey(0)

# # Image 2 # #

img2 = cv.imread('OpenPano/flower/2.jpg')

cv.namedWindow('Flower_2', cv.WINDOW_NORMAL)
cv.imshow('Flower_2', img2)
cv.waitKey(0)
...
img3 = cv.imread('OpenPano/flower/3.jpg')

cv.namedWindow('Flower_3', cv.WINDOW_NORMAL)
cv.imshow('Flower_3', img3)
cv.waitKey(0)
...
cv.imshow('Flower_3', k_img3)
cv.waitKey(0)

# # Image 4 # #

img4 = cv.imread('OpenPano/flower/4.jpg')

cv.namedWindow('Flower_4', cv.WINDOW_NORMAL)
cv.imshow('Flower_4', img4)
cv.waitKey(0)
...
img_1_2 = cv.warpPerspective(img2, M, (img1.shape[1]+300, img1.shape[0]))
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+300, img3.shape[0]))
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+800, img_1_2.shape[0]))
...
cv.imwrite('OpenPano/flower/Stitched_Sift.jpg', img_all)
