...
surf = cv.xfeatures2d_SURF.create(8000)  # 8000
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+950, img3.shape[0]))  # 825
...
surf = cv.xfeatures2d_SURF.create(8000)  # 9000
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+3650, img_1_2.shape[0]))  # 2900
...
cv.imwrite('ESTIES_STABLE/Stitched_Surf.jpg', img_all)
