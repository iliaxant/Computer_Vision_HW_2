...
img1 = cv.imread('ESTIES_STABLE/1.jpg')  # All images in ESTIES_STABLE have resolution: (3072, 4080)
...
img2 = cv.imread('ESTIES_STABLE/2.jpg')
...
sift = cv.xfeatures2d_SIFT.create(1500)

img3 = cv.imread('ESTIES_STABLE/3.jpg')
...
img4 = cv.imread('ESTIES_STABLE/4.jpg')
...
img_1_2 = cv.warpPerspective(img2, M, (img1.shape[1]+970, img1.shape[0]))  # 970
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+825, img3.shape[0]))  # 700
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+2900, img_1_2.shape[0]))  # 800
...
cv.imwrite('ESTIES_STABLE/Stitched_Sift.jpg', img_all)
