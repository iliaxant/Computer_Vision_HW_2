...
surf = cv.xfeatures2d_SURF.create(3750)
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+700, img_1_2.shape[0]))
img_all[0: img_1_2.shape[0], 0: img_1_2.shape[1]] = img_1_2
img_all = img_all[0:img_all.shape[0]-25, :]

cv.imshow('All-Matched', img_all)
cv.waitKey(0)

cv.imwrite('OpenPano/flower/Stitched_Surf.jpg', img_all)
