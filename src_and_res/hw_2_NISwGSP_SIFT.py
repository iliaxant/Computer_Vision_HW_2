...
sift = cv.xfeatures2d_SIFT.create(3000)
...
img_3_4 = cv.warpPerspective(img4, M, (img3.shape[1]+1000, img3.shape[0]+2000))
...
img_all = cv.warpPerspective(img_3_4, M, (img_1_2.shape[1]+1800, img_1_2.shape[0]))  # 800
img_all[0: img_1_2.shape[0], 0: img_1_2.shape[1]] = img_1_2
img_all = img_all[0:img_all.shape[0]-800, :]

cv.imshow('All-Matched', img_all)
cv.waitKey(0)

cv.imwrite('NISwGSP/Stitched_Sift.jpg', img_all)
